    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, null=True, upload_to=server.models.category_icon_upload_path, validators=[server.validators.validate_icon_image_size, server.validators.validate_image_file_extension])),
            ],
        ),
        migrations.CreateModel(
            name='Server',
            fields=[
                ...
                ('icon', models.ImageField(null=True, upload_to=server.models.server_icon_upload_path, validators=[server.validators.validate_icon_image_size, server.validators.validate_image_file_extension])),
